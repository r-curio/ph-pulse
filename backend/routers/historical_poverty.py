...
async def list_historical_regions(
...
async def get_historical_region(region_name: str) -> HistoricalRegionDetailResponse:
...
async def get_historical_national_data() -> HistoricalPovertyResponse:
